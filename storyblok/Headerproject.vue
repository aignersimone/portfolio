<template>
  <div v-editable="blok" class="mb-5 bg-gray-300 pt-5 flex flex-wrap items-center justify-center">
    <div class=" imagediv lg:w-1/2 flex justify-start lg:justify-center mb-5">
      <img :src="blok.image.filename" class="logoimage" alt="Portrait"/>
    </div>
...
interface Header extends SbComponent{
  image: string;
  teaser: string;
  shortinfo: string;
}
